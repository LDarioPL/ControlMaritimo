 ...
 * @author yazid
 */
public class OperacionesBarcoPasajeros extends Barco implements IOperacionesBarco {
    
    Scanner leer = new Scanner(System.in);

    public OperacionesBarcoPasajeros(String matricula, String bandera,
                                     String nombre, double pesoToneladas,
                                     LocalDate fechaBotadura) {

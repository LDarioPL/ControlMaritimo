 ...
 * de documentos de atraque (transacciones de barcos en puertos)
 * 
 * @author emilio
 */
public class OperacionesDocumentoAtraque implements IOperacionesDocumentos {
    ...
    public void consultarDocumento() {
        ...
        switch (opcion) {
            case 1 -> consultarPorBarco();
            case 2 -> consultarPorPuerto();
            case 3 -> listarTodosAtraques();
            default -> System.out.println("Opción no válida.");
        }
    }
    
    /**
     * Consulta atraques por barco
     */
    ...
    /**
     * Lista todos los atraques registrados
     */
